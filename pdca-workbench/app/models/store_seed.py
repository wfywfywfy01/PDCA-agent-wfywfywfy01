...
_STORES: list[tuple[str, str, str, str, str, str]] = [
    ...
    ("sea02a", "VMG Communication and Technology JSC · Dong Khoi", "东南亚", "越南", "L2", "Ivan"),
    ("sea02b", "VMG Communication and Technology JSC · Caravelle", "东南亚", "越南", "L2", "Ivan"),
    ("sea02c", "VMG Communication and Technology JSC · Majestic",  "东南亚", "越南", "L2", "Ivan"),
    ("sea02d", "VMG Communication and Technology JSC · REX",       "东南亚", "越南", "L2", "Ivan"),
